...
const gamesMockData = [
  {
    ...
    name: "Battlefield",
    price: 30.99,
    image: "images/games/battlefield1.jpg",
    rating: 5,
    platforms: ["pc"],
  ...
  },
  {
    ...
    name: "Genshin Impact",
    price: 13.99,
    image: "images/games/genshinimpact.jpg",
    rating: 5,
    platforms: ["pc"],
    addDate: new Date("2023-01-03"),
  },
  { id: 4, name: "GTA", price: 18.99, image: "images/games/gta.jpg", rating: 5, platforms: ["pc"], addDate: new Date("2023-01-01") },
  {
    id: 5,
    name: "Minecraft",
    price: 25.99,
